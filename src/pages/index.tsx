                        ...
                        <div className="space-y-20">
                            <section className="mb-20">
                                ...
                                <SquareBox
                                    ...
                                    description={
                                        "The part of Java journey. Every Lombok related knowledge you might need"
                                    }
                                ...
                                <SquareBox
                                    ...
                                    description={
                                        "Application for \"Polskie Stowarzyszenie Studentów i Absolwentów Psychologii\", Event located in Łódź, 2024"
                                    }
                                ...
                                <SquareBox
                                    title={"Sudoku Solver"}
                                    description={
                                        "Just another sudoku solver... but with GUI"
                                    }
                                ...
                                <SquareBox
                                    ...
                                    description={
                                        "Old school testing library for testing input-outputs and type checking with mypy"
                                    }
                                ...
                                <SquareBox
                                    title={"Game of Life"}
                                    description={
                                        "Just another game of life implementation... but with GUI"
                                    }
                            ...
                            <section className="mb-20">
                                <h2 className="text-3xl font-bold text-center mb-6">
                                    Tech Demo (not finished but interesting)
                                </h2>
                                <SquareBox
                                    title={"Java Spring Boot 3 - Auth Example"}
                                    description={
                                        "Simple example of stateless token auth with Spring Boot 3 + Spring Security 6"
                                    }
                            ...
                            <section className="mb-20">
                                ...
                                <SquareBox
                                    ...
                                    description={
                                        "Inspired by Otchlan. (Sort of) game engine for text games"
                                    }
                            ...
                            <section className="mb-20">
                                ...
                                <SquareBox
                                    title={"Datafaker"}
                                    description={
                                        "Fixed a couple of bugs related to 🇸🇪Swedish SSN generation and validation"
                                    }
                                ...
                                <SquareBox
                                    ...
                                    description={
                                        "Small contribution to the private bin - API for Java"
                                    }
                                ...
                                <SquareBox
                                    title={"Cucumber JVM"}
                                    description={
                                        "Small contribution to the cucumber testing framework"
                                    }
                                ...
                                <SquareBox
                                    title={"Fast Ruby"}
                                    description={
                                        "Small contribution to the fast ruby repository"
                                    }
                            ...
                            <section className="mb-20">
                                ...
                                <SquareBox
                                    ...
                                    link={"https://github.com/TrueJacobG/advent-of-code-2024"}
                                    linkText={"View Project"}
                                />
                                <SquareBox
                                    title={"AoC 2023"}
                                    ...
                                    link={"https://github.com/TrueJacobG/advent-of-code-2023"}
                                    linkText={"View Project"}
                                />
                                <SquareBox
                                    title={"AoC 2022"}
                                    ...
                                    link={"https://github.com/TrueJacobG/advent-of-code-2022"}
                                    linkText={"View Project"}
                                />
                                <SquareBox
                                    title={"AoC 2021"}
                                    ...
                                    link={"https://github.com/TrueJacobG/advent-of-code-2021"}
                                    linkText={"View Project"}
                                />
                            ...
                            <div>
                                ...and a couple more you can find on my github 😄
                            </div>
                        </div>
                    </main>
                </div>
